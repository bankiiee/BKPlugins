...
var isHideEggWgh = ($.Ctx.GetPageParam('efficiency_list', 'param').STK_TYPE == 30 ? true : false);
var isHideUniform = ($.Ctx.GetPageParam('efficiency_list', 'param').STK_TYPE == 30 ? true : false);
...
function initPage() {
    ...
    if (isHideEggWgh)
        $('#efficiency_detail #boxEggWgh').hide();
    else
        $('#efficiency_detail #boxEggWgh').show();
    if (isHideUniform)
        $('#efficiency_detail #boxUniform').hide();
    else
        $('#efficiency_detail #boxUniform').show();
