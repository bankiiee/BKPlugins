...
@synthesize isImage;
@synthesize delegate, progressHUD;
...
- (void)webViewDidStartLoad:(UIWebView *)sender {
    ...
    [self.progressHUD setLabelFont:[UIFont fontWithName:@"Futura" size:16.0]];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error{
    UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"Connection Fail!" message:@"Unable to connect to target host, please try again." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
